...
public class InHospitalInfo {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof InHospitalInfo)) {
            return false;
        }
        InHospitalInfo other = (InHospitalInfo) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof InHospitalInfo;
    }
    ...
    public void transfer(PatientInfo patientInfo) {
        this.pid = patientInfo.getPid();
        this.mrn = patientInfo.getMrn();
        this.zycs = patientInfo.getZycs();
        this.yblx = patientInfo.getYblx();
        this.jzkh = patientInfo.getJzkh();
        this.name = patientInfo.getName();
        this.gender = patientInfo.getGender();
        this.dob = patientInfo.getDob();
        this.age = patientInfo.getAge();
        this.admitTime = patientInfo.getAdmitTime();
        this.inPatientTime = patientInfo.getInPatientTime();
        this.dept = patientInfo.getDept();
        this.deptCode = patientInfo.getDeptCode();
        this.bed = patientInfo.getBed();
        this.zyzt = patientInfo.getZyzt();
        this.dischargeTime = patientInfo.getDischargeTime();
        ...
        this.blood = patientInfo.getBlood();
        this.tel = patientInfo.getTel();
        this.operation = patientInfo.getOperation();
        this.operTime = patientInfo.getOperTime();
        this.diagnose = patientInfo.getDiagnose();
        this.vip = patientInfo.getVip();
        this.illnessLevel = patientInfo.getIllnessLevel();
        this.allergic = patientInfo.getAllergic();
        this.zhushu = patientInfo.getZhushu();
        this.doctor = patientInfo.getDoctor();
        this.doctorID = patientInfo.getDoctorID();
        this.shouYeXuHao = patientInfo.getShouYeXuHao();
        this.hisVisitId = patientInfo.getHisVisitId();
        this.admissionType = patientInfo.getAdmissionType();
    }
}